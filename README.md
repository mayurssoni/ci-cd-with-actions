[![React App CI](https://github.com/mayurssoni/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/mayurssoni/ci-cd-with-actions/actions/workflows/ci.yml)
